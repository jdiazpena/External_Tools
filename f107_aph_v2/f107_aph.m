...
% convert year to string added datestr
[YApa, ~, ~, ~, ~, ~] = datevec(daten);
yrstr = num2str(unique([YAp YApa]));
N = size(yrstr,1);
...
% define full local directories Laptop
localFolder = strcat('D:\Google Drive\PhD Data\','LargeFiles',filesep,'KP_AP',filesep);
% % Desktop
% localFolder = strcat('D:\JMDP\Google Drive\PhD Data\','LargeFiles',filesep,'KP_AP',filesep);
